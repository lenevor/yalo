                ...
                <div class="form-group-card">
                    ...
                    <div class="form-group-card-body">
                        <div class="form-message">
                            <p class="message">
                                {{ __('Forgot your password? No problem. It\'s very easy, you let us know your email address and we will send you a password reset link where you may choose a new one.') }}
                            </p>
                        </div>
