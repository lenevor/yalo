            ...
            <div class="form-group-container">
                <div class="form-group-card">
                    <div class="form-group-card-header">
                        <svg width="50" height="50" viewBox="0 0 165 170" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                           ...
                           <div class="group-label-input">
                                ...
                                <div class="input-wrapper">
                                    <i class="icon-user"></i>
                                    <input id="name" class="form-input" type="name" name="name" value="" required autofocus />                                    
                                </div>
                            </div>
                            <!-- Email Address -->
                           <div class="group-label-input">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input id="email" class="form-input" type="email" name="email" value="" required autofocus />
                                </div>
                            </div>
                            <!-- Password -->
                            <div class="group-label-input">
                            ...
                            <div class="group-label-input">
                                ...
                                <div class="input-wrapper">
                                    <i class="icon-password"></i>
                                    <input id="password" class="form-input" type="password" name="password_confirmation" required autocomplete="current-password" />
                                </div>
                            </div>
                            <!-- Submit -->
                            <div class="group-label-input">
